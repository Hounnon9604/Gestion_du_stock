...
if(isset($_POST['valid'])){
    if(isset($_POST['e_mail'],$_POST['ville'],$_POST['telephone']))
    {
        $inscrit=$conn->prepare('INSERT INTO fournisseur(e_mail,ville,telephone) VALUES(?,?,?) ');
        $inscrit=$inscrit->execute([
            htmlspecialchars($_POST['e_mail']),
...
<div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="fournisseur.php" class="active"><span class="fas fa-male"></span>
    ...
    <form class="af" method="POST" action="">
        ...
        <h2> Enrégistrer un fournisseur</h2>
        <!-- <input type="number" placeholder="id_produit" required><br><br> -->
        <input type="email" id="email" name="e_mail" placeholder="E-mail" required><br><br>
